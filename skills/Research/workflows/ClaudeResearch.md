 ...
 * ## Usage
 * ```bash
 * bun ~/.claude/commands/perform-claude-research.md "your complex research question here"
 * ```
 *
 * ## Features
...
if (!originalQuestion) {
  ...
  console.error('Usage: bun ~/.claude/commands/perform-claude-research.md "your question here"');
  process.exit(1);
}
