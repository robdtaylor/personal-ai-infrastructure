...
**Procedure:** Receive grievance → investigate → grievance meeting → outcome → appeal
...
**Process:** Set clear objectives → regular reviews → support/training → improvement plan → capability procedure if no improvement
