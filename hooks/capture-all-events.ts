...
import { PAI_DIR, getRawOutputsFilePath, ensureDir } from './lib/pai-paths';
...
// Get current events file path (uses MEMORY/History/raw-outputs/)
function getEventsFilePath(): string {
  const filePath = getRawOutputsFilePath();
